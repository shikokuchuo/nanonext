...
#' nanonext Initialise
#'
#' Initialise global options [DEPRECATED]. This function prints a deprecation
#'     message and no longer has any effect.
#'
...
nano_init <- function(warn = c("immediate", "deferred", "error", "none")) {
  ...
  cat("nanonext 0.7.0 | 'nano_init()' is deprecated as an 'errorValue' no longer generates a warning\n",
      file = stderr())
