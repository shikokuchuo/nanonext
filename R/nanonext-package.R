...
#' WebSocket and secure TLS transports. Implements
#' \sQuote{Scalability Protocols}, a standard for common communications patterns
#' including publish/subscribe, request/reply and service discovery. As its own
