...
#'     for communications patterns including publish/subscribe, request/reply
#'     and service discovery, over in-process, IPC, TCP, WebSocket and secure
#'     TLS transports. As its own threaded concurrency framework, provides a
#'     toolkit for asynchronous programming and distributed computing, with
#'     intuitive 'aio' objects which resolve automatically upon completion of
