...
#>  num [1:100000000] -1.1374 -1.5803 -0.673 -0.9664 0.0406 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t=1721817788.476\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-66a0dabc-57743a5b5af092601453d8dc\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Wed, 24 Jul 2024 10:43:09 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t=1721817789.057\",\n    \"content-length\": \"16\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-66a0dabc-043b4cbf50634dca71fb6a94\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#>  [77] 74 2d 73 74 61 72 74 22 3a 20 22 74 3d 31 37 32 31 38 31 37 37 38 39 2e 35 33 31 22 2c 0a 20 20 20 20 22 78 2d 66
...
#> [191] 64 22 3a 20 22 52 6f 6f 74 3d 31 2d 36 36 61 30 64 61 62 64 2d 33 32 35 63 36 32 66 37 35 35 66 63 34 33 62 31 31
#> [229] 63 32 31 61 38 31 37 22 2c 0a 20 20 20 20 22 63 6f 6e 74 65 6e 74 2d 74 79 70 65 22 3a 20 22 61 70 70 6c 69 63 61
