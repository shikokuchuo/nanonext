...
#>  num [1:100000000] 0.749 0.181 -0.535 -0.276 -0.429 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t=1718802982.715\",\n    \"connection\": \"close\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-6672da26-2a89a683165fc22d595ba158\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Wed, 19 Jun 2024 13:16:23 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t=1718802983.344\",\n    \"connection\": \"close\",\n    \"content-length\": \"16\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-6672da27-5cf9a608751ac05b26cff98c\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#>  [77] 74 2d 73 74 61 72 74 22 3a 20 22 74 3d 31 37 31 38 38 30 32 39 38 33 2e 38 36 37 22 2c 0a 20 20 20 20 22 63 6f 6e
...
#> [229] 2d 36 36 37 32 64 61 32 37 2d 31 32 39 64 38 36 64 61 34 30 61 33 30 64 36 39 35 38 39 37 66 31 36 39 22 2c 0a 20
