...
#> < recvAio | $data >
aio$data |> str()
#>  num [1:100000000] 1.725 0.263 0.484 -0.144 -0.809 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-65cccbc9-7536cf3e51e166df2474cbec\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Wed, 14 Feb 2024 14:18:49 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-65cccbc9-64d4d19f6cd7be111b749662\",\n    \"content-length\": \"16\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> $headers
#> $headers$Date
#> [1] "Wed, 14 Feb 2024 14:18:50 GMT"
#> 
...
#> [161] 35 63 63 63 62 63 61 2d 37 64 65 64 32 31 35 65 36 65 33 64 32 65 39 66 32 37 38 36 38 38 32 30 22 2c 0a 20 20 20 20 22
