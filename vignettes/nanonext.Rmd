...
#> < recvAio | $data >
aio$data |> str()
#>  num [1:100000000] -0.138 -0.409 1.262 0.852 -0.695 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-65db2b81-053ca2ba13fefb8f4f31af52\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Sun, 25 Feb 2024 11:58:58 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-65db2b81-7c7fcf8614f36d017276a64c\",\n    \"content-length\": \"16\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> [161] 35 64 62 32 62 38 32 2d 34 65 61 31 39 36 39 62 32 39 39 62 66 32 64 36 30 61 36 32 63 34 35 31 22 2c 0a 20 20 20 20 22
...
Hash functions using the SHA-2 algorithms are included: `sha224()`, `sha256()`, `sha384()` and `sha512()`.
