...
#> < recvAio | $data >
aio$data |> str()
#>  num [1:100000000] 0.27417 -0.00471 -0.24613 -1.75302 -0.18463 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-65a50fb6-69d470382da1a27d198fce4b\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Mon, 15 Jan 2024 10:57:59 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-65a50fb7-5a00690711526bdc09fa58ee\",\n    \"content-length\": \"16\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> [161] 35 61 35 30 66 62 37 2d 37 34 33 64 31 62 30 39 31 33 38 35 32 64 30 34 35 34 36 64 32 62 63 36 22 2c 0a 20 20 20 20 22
