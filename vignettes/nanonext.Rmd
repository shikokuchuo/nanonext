...
#> < recvAio | $data >
aio$data |> str()
#>  num [1:100000000] 1.018 -1.367 -0.694 -0.987 -0.187 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-659c037f-620d52181c19506d465b0d25\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Mon, 08 Jan 2024 14:15:28 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-659c0380-7f4964845fab808564de9eee\",\n    \"content-length\": \"16\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> $headers
#> $headers$Date
#> [1] "Mon, 08 Jan 2024 14:15:29 GMT"
#> 
...
#> [161] 35 39 63 30 33 38 31 2d 33 30 38 33 32 33 64 38 36 33 65 61 37 62 34 36 31 66 38 38 62 30 66 36 22 2c 0a 20 20 20 20 22
