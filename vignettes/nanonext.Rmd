...
#> < recvAio | $data >
aio$data |> str()
#>  num [1:100000000] -1.268 0.398 -0.797 0.306 -0.987 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-65ca9685-6fb3f1dd442c7ae67768845d\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Mon, 12 Feb 2024 22:07:02 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-65ca9686-3d0e15bb5e56b63b2f32acd1\",\n    \"content-length\": \"16\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> [161] 35 63 61 39 36 38 36 2d 32 61 65 35 36 36 66 33 33 38 39 32 39 65 64 61 36 61 63 34 30 37 61 39 22 2c 0a 20 20 20 20 22
