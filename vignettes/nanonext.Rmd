...
#> < recvAio | $data >
aio$data |> str()
#>  num [1:100000000] -0.267 -0.353 0.963 0.39 1.479 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-65a98326-6f6c91ea126b5f9054afdcf7\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Thu, 18 Jan 2024 19:59:35 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-65a98326-4c76a8f4099ac2f366fdce2d\",\n    \"content-length\": \"16\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> [161] 35 61 39 38 33 32 37 2d 35 66 65 64 34 62 65 38 31 66 65 64 33 66 62 32 33 32 33 32 66 65 63 64 22 2c 0a 20 20 20 20 22
