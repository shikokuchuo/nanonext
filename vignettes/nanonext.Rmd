...
#>  - $data for message data
aio$data |> str()
#>  num [1:100000000] 0.1 1.888 0.958 -2.018 -1.705 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-659713c4-10fa6d6d200c16105dcca271\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Thu, 04 Jan 2024 20:23:32 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-659713c4-0a02761044503625288cb677\",\n    \"content-length\": \"16\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> $headers
#> $headers$Date
#> [1] "Thu, 04 Jan 2024 20:23:33 GMT"
#> 
...
#> [161] 35 39 37 31 33 63 35 2d 33 35 65 66 63 37 32 64 34 38 35 31 37 39 32 37 32 31 65 61 64 63 31 32 22 2c 0a 20 20 20 20 22
