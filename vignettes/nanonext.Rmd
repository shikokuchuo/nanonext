...
#>  num [1:100000000] 0.775 1.298 1.074 1.897 -0.189 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t=1719947486.582\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-668450de-7a3a4e5f4c2dee8d376e8af1\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Tue, 02 Jul 2024 19:11:27 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t=1719947487.151\",\n    \"content-length\": \"16\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-668450df-08ef439d71fa82dc2c595be5\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#>  [77] 74 2d 73 74 61 72 74 22 3a 20 22 74 3d 31 37 31 39 39 34 37 34 38 37 2e 37 39 34 22 2c 0a 20 20 20 20 22 78 2d 66
...
#> [191] 64 22 3a 20 22 52 6f 6f 74 3d 31 2d 36 36 38 34 35 30 64 66 2d 30 37 39 32 36 64 66 38 37 33 62 32 33 31 39 35 37
#> [229] 38 35 33 34 34 37 65 22 2c 0a 20 20 20 20 22 63 6f 6e 74 65 6e 74 2d 74 79 70 65 22 3a 20 22 61 70 70 6c 69 63 61
