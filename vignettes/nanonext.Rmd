...
8. [ncurl / asyncurl: HTTP Clients](#ncurl-asyncurl-http-clients)
...
#>  num [1:100000000] 0.815 -1.129 -1.017 0.751 1.49 ...
```
...
### ncurl / asyncUrl: HTTP Clients

`ncurl()` is a minimalist http(s) client.

`asyncurl()` is the async edition, performing requests asynchronously, returning immediately with an 'asyncUrl'.
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t=1722183349.859\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-66a66eb5-6202444f3cf044ae631cb405\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
``` r
res <- asyncurl("https://postman-echo.com/post",
                method = "POST",
                headers = c(`Content-Type` = "application/json", Authorization = "Bearer APIKEY"),
                data = '{"key": "value"}',
                response = "date")
res
#> < asyncUrl | $status $headers $data >

call_aio(res)$headers
#> $date
#> [1] "Sun, 28 Jul 2024 16:15:50 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"host\": \"postman-echo.com\",\n    \"x-request-start\": \"t=1722183350.404\",\n    \"content-length\": \"16\",\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"x-amzn-trace-id\": \"Root=1-66a66eb6-2370eaa055ec65ec5417a349\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
`asyncurl()` may also be used anywhere that accepts a ‘promise’ from the promises package, including with Shiny ExtendedTask.
...
p <- asyncurl("https://postman-echo.com/get") %...>% cat
is.promise(p)
#> [1] TRUE
```
##### ncurl Session
...
#> 
#> $data
#>   [1] 7b 0a 20 20 22 61 72 67 73 22 3a 20 7b 7d 2c 0a 20 20 22 68 65 61 64 65 72 73 22 3a 20 7b 0a 20 20 20 20 22 68 6f
#>  [39] 73 74 22 3a 20 22 70 6f 73 74 6d 61 6e 2d 65 63 68 6f 2e 63 6f 6d 22 2c 0a 20 20 20 20 22 78 2d 72 65 71 75 65 73
#>  [77] 74 2d 73 74 61 72 74 22 3a 20 22 74 3d 31 37 32 32 31 38 33 33 35 30 2e 38 32 39 22 2c 0a 20 20 20 20 22 78 2d 66
#> [115] 6f 72 77 61 72 64 65 64 2d 70 72 6f 74 6f 22 3a 20 22 68 74 74 70 73 22 2c 0a 20 20 20 20 22 78 2d 66 6f 72 77 61
#> [153] 72 64 65 64 2d 70 6f 72 74 22 3a 20 22 34 34 33 22 2c 0a 20 20 20 20 22 78 2d 61 6d 7a 6e 2d 74 72 61 63 65 2d 69
#> [191] 64 22 3a 20 22 52 6f 6f 74 3d 31 2d 36 36 61 36 36 65 62 36 2d 34 37 39 66 66 39 66 38 35 39 35 35 34 61 39 32 32
#> [229] 35 33 35 64 65 37 39 22 2c 0a 20 20 20 20 22 63 6f 6e 74 65 6e 74 2d 74 79 70 65 22 3a 20 22 61 70 70 6c 69 63 61
#> [267] 74 69 6f 6e 2f 6a 73 6f 6e 22 2c 0a 20 20 20 20 22 61 75 74 68 6f 72 69 7a 61 74 69 6f 6e 22 3a 20 22 42 65 61 72
#> [305] 65 72 20 41 50 49 4b 45 59 22 0a 20 20 7d 2c 0a 20 20 22 75 72 6c 22 3a 20 22 68 74 74 70 73 3a 2f 2f 70 6f 73 74
#> [343] 6d 61 6e 2d 65 63 68 6f 2e 63 6f 6d 2f 67 65 74 22 0a 7d
```
