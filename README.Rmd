...
- [ncurl](https://shikokuchuo.net/nanonext/articles/nanonext.html#ncurl-asyncurl-http-clients) - minimalist http(s) client
- [asyncurl](https://shikokuchuo.net/nanonext/articles/nanonext.html#ncurl-asyncurl-http-clients) - async http(s) client, supporting event-driven promises and Shiny ExtendedTask
