...
- a system installation of 'libnng' newer than v1.6.0 pre-release (722bf46), or
- 'cmake' to compile 'libnng' v1.6.0 (722bf46) included within the package sources 

Note: the required version of NNG is not yet available in system repositories and includes features implemented specifically for 'nanonext'.
...
Detection and required configuration/compilation is performed automatically during package installation. 
