...
- [Luke Tierney](https://homepage.stat.uiowa.edu/~luke/) and [Mike Cheng](https://github.com/coolbutuseless) for meticulous documentation of R's serialization mechanism, which led to the package's own implementation of a low-level interface to R serialisation.
