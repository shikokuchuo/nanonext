...
- [sha224|256|384|512](https://shikokuchuo.net/nanonext/articles/nanonext.html#cryptographic-hashing) - cryptographic hash and HMAC algorithms
...
For previous R versions, pre-compiled 'libnng' v1.7.0 and 'libmbedtls' v3.5.2 libraries are downloaded and used for installation instead.
...
- [Luke Tierney](https://homepage.stat.uiowa.edu/~luke/) and [Mike Cheng](https://github.com/coolbutuseless) for meticulous documentation of the R serialization mechanism, which led to the package's own implementation of a low-level interface to R serialization.
