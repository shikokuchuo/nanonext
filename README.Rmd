...
R binding for NNG (Nanomsg Next Gen), a successor to ZeroMQ. NNG implements Scalability Protocols, a reliable, high-performance messaging standard for communications patterns including publish/subscribe, request/reply and service discovery, over in-process, IPC, TCP, WebSocket and secure TLS transports.
