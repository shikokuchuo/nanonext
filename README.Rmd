...
Installation from source requires 'libnng' >= v1.6.0 and 'libmbedtls' >= 2.5.0 (suitable installations are automatically detected), or else 'cmake' to compile 'libnng' v1.7.2 and 'libmbedtls' v3.5.2 included within the package sources.
...
For R >= 4.2 using the 'Rtools42' or newer toolchains, 'libnng' v1.7.2 and 'libmbedtls' v3.5.2 will be automatically compiled from the package sources during installation.
