...
For R >= 4.2 using the 'Rtools42' or newer toolchains, 'libnng' v1.8.0 and 'libmbedtls' v3.6.0 LTS will be automatically compiled from the package sources during installation.
