...
[![codecov](https://codecov.io/gh/shikokuchuo/nanonext/branch/main/graph/badge.svg)](https://codecov.io/gh/shikokuchuo/nanonext)
<!-- badges: end -->
...
Installation from source requires 'libnng' >= v1.6.0 and 'libmbedtls' >= 2 - suitable installations are automatically detected - or else 'cmake' to compile 'libnng' v1.6.0 pre-release (722bf46) and 'libmbedtls' v3.2.1 included within the package sources.
...
For R >= 4.2 using the 'rtools42' toolchain, 'libnng' v1.6.0 (722bf46) and 'libmbedtls' v3.2.1 will be automatically compiled from the package sources during installation.
