...
[![r-releases status](https://r-releases.r-universe.dev/badges/nanonext?color=0043ce)](https://r-releases.r-universe.dev/nanonext)
[![dev version status](https://shikokuchuo.r-universe.dev/badges/nanonext?color=3f72af)](https://shikokuchuo.r-universe.dev/nanonext)
...
Installation from source requires 'libnng' >= v1.5.0 and 'libmbedtls' >= 2.5.0 (suitable installations are automatically detected), or else 'cmake' to compile 'libnng' v1.7.3 and 'libmbedtls' v3.5.2 included within the package sources.
