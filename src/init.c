...
static const R_CallMethodDef CallEntries[] = {
  ...
  {"rnng_aio_stream_in", (DL_FUNC) &rnng_aio_stream_in, 2},
  ...
  {"rnng_ctx_recv_aio", (DL_FUNC) &rnng_ctx_recv_aio, 3},
  {"rnng_ctx_send_aio", (DL_FUNC) &rnng_ctx_send_aio, 4},
  ...
  {"rnng_stream_recv_aio", (DL_FUNC) &rnng_stream_recv_aio, 4},
