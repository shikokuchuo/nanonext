...
void nano_serialize(nano_buf *, const SEXP, const SEXP);
SEXP nano_unserialize(unsigned char *, const size_t, const SEXP);
SEXP nano_decode(unsigned char *, const size_t, const int, const SEXP);
...
SEXP rnng_serial_config(SEXP, SEXP, SEXP, SEXP, SEXP);
