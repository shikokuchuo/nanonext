...
extern SEXP rnng_ctx_recv_aio(SEXP, SEXP, SEXP);
extern SEXP rnng_ctx_send_aio(SEXP, SEXP, SEXP, SEXP);
...
extern SEXP rnng_stream_recv_aio(SEXP, SEXP, SEXP, SEXP);
