...
#>  - $data for message data
aio$data |> str()
#>  num [1:100000000] -0.297 0.275 0.707 -1.044 -0.398 ...
```
...
#>  [76] 2d 36 32 34 65 63 32 38 35 2d 33 62 62 61 38 65 32 65 35 36 64 33 62 61 32
#> [101] 64 34 66 66 30 66 31 62 31 22 0a 20 20 7d 0a 7d 0a
#> 
#> $data
#> [1] "{\n  \"headers\": {\n    \"Host\": \"httpbin.org\", \n    \"X-Amzn-Trace-Id\": \"Root=1-624ec285-3bba8e2e56d3ba2d4ff0f1b1\"\n  }\n}\n"
```
...
call_aio(res)$data
#> [1] "{\n  \"args\": {}, \n  \"data\": \"{\\\"key\\\": \\\"value\\\"}\", \n  \"files\": {}, \n  \"form\": {}, \n  \"headers\": {\n    \"Authorization\": \"Bearer APIKEY\", \n    \"Content-Length\": \"16\", \n    \"Content-Type\": \"application/json\", \n    \"Host\": \"httpbin.org\", \n    \"X-Amzn-Trace-Id\": \"Root=1-624ec285-50b93ac52ef3f15166488236\"\n  }, \n  \"json\": {\n    \"key\": \"value\"\n  }, \n  \"origin\": \"79.173.189.204\", \n  \"url\": \"http://httpbin.org/post\"\n}\n"
```
