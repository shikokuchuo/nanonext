...
#>  - $data for message data
aio$data |> str()
#>  num [1:100000000] -2.1731 -0.0272 0.0384 -0.2622 -0.0859 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-6527de1e-7bfedd28285f331a67d7f58e\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Thu, 12 Oct 2023 11:53:03 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-6527de1e-0bcaa6f46aef87c91ec4105b\",\n    \"content-length\": \"16\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> [151] 20 22 52 6f 6f 74 3d 31 2d 36 35 32 37 64 65 31 66 2d 34 66 34 34 32 35 66
#> [176] 64 30 31 31 66 37 38 35 33 36 35 63 34 39 61 65 33 22 2c 0a 20 20 20 20 22
