...
#>  - $data for message data
aio$data |> str()
#>  num [1:100000000] -0.165 1.111 -0.996 -2.7 1.285 ...
```
...
#>  [76] 2d 36 33 31 37 30 62 38 38 2d 34 34 30 34 30 35 64 33 37 65 61 63 62 62 39
#> [101] 37 32 61 32 65 61 31 64 34 22 0a 20 20 7d 0a 7d 0a
#> 
#> $data
#> [1] "{\n  \"headers\": {\n    \"Host\": \"httpbin.org\", \n    \"X-Amzn-Trace-Id\": \"Root=1-63170b88-440405d37eacbb972a2ea1d4\"\n  }\n}\n"
```
...
#> $Date
#> [1] "Tue, 06 Sep 2022 08:57:44 GMT"
#> 
#> $Server
#> [1] "gunicorn/19.9.0"

res$data
#> [1] "{\n  \"args\": {}, \n  \"data\": \"{\\\"key\\\": \\\"value\\\"}\", \n  \"files\": {}, \n  \"form\": {}, \n  \"headers\": {\n    \"Authorization\": \"Bearer APIKEY\", \n    \"Content-Length\": \"16\", \n    \"Content-Type\": \"application/json\", \n    \"Host\": \"httpbin.org\", \n    \"X-Amzn-Trace-Id\": \"Root=1-63170b88-3788784809d2e6ad7fe535aa\"\n  }, \n  \"json\": {\n    \"key\": \"value\"\n  }, \n  \"origin\": \"213.86.169.34\", \n  \"url\": \"http://httpbin.org/post\"\n}\n"
```
...
s |> recv(keep.raw = FALSE)
#> [1] "{\"s\":\"EURUSD\",\"a\":0.99593,\"b\":0.99591,\"dc\":\"0.0934\",\"dd\":\"0.0009\",\"ppms\":false,\"t\":1662454665000}"

s |> recv(keep.raw = FALSE)
#> [1] "{\"s\":\"EURUSD\",\"a\":0.99592,\"b\":0.9959,\"dc\":\"0.0924\",\"dd\":\"0.0009\",\"ppms\":false,\"t\":1662454665000}"
