...
standard for communications patterns including publish/subscribe,
request/reply and service discovery, over in-process, IPC, TCP,
...
#>  - $data for message data
aio$data |> str()
#>  num [1:100000000] -0.568 -0.726 -0.624 -1.929 0.291 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-653f7bab-5997d72813a18e790963c7b6\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Mon, 30 Oct 2023 09:47:25 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-653f7bad-78bb97bd658267cb0c6f3bc1\",\n    \"content-length\": \"16\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> [151] 20 22 52 6f 6f 74 3d 31 2d 36 35 33 66 37 62 61 64 2d 30 61 61 64 65 63 34
#> [176] 62 33 36 33 62 35 61 61 62 34 38 30 63 34 33 61 61 22 2c 0a 20 20 20 20 22
