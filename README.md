...
#>  - $data for message data
aio$data |> str()
#>  num [1:100000000] -0.854 2.167 -0.509 1.043 -0.702 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-64db7f64-552ef3fd47f51e385cc5ab07\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Tue, 15 Aug 2023 13:36:37 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-64db7f65-0cb2b96e535eb35401cb2a91\",\n    \"content-length\": \"16\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> [151] 20 22 52 6f 6f 74 3d 31 2d 36 34 64 62 37 66 36 35 2d 37 34 36 32 63 38 37
#> [176] 32 35 37 32 34 30 34 33 62 33 64 61 38 38 33 34 37 22 2c 0a 20 20 20 20 22
