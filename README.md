...
#>  - $data for message data
aio$data |> str()
#>  num [1:100000000] -0.0389 -0.225 0.2612 1.1667 -1.3052 ...
```
...
#>  [76] 2d 36 34 32 31 65 38 34 61 2d 36 61 39 31 39 64 31 35 34 37 33 61 66 31 63
#> [101] 37 35 30 39 61 63 31 38 65 22 0a 20 20 7d 0a 7d 0a
#> 
#> $data
#> [1] "{\n  \"headers\": {\n    \"Host\": \"httpbin.org\", \n    \"X-Amzn-Trace-Id\": \"Root=1-6421e84a-6a919d15473af1c7509ac18e\"\n  }\n}\n"
```
...
#> $Date
#> [1] "Mon, 27 Mar 2023 19:02:34 GMT"
#> 
#> $Server
#> [1] "gunicorn/19.9.0"

res$data
#> [1] "{\n  \"args\": {}, \n  \"data\": \"{\\\"key\\\": \\\"value\\\"}\", \n  \"files\": {}, \n  \"form\": {}, \n  \"headers\": {\n    \"Authorization\": \"Bearer APIKEY\", \n    \"Content-Length\": \"16\", \n    \"Content-Type\": \"application/json\", \n    \"Host\": \"httpbin.org\", \n    \"X-Amzn-Trace-Id\": \"Root=1-6421e84a-580ba5943c53265b43444749\"\n  }, \n  \"json\": {\n    \"key\": \"value\"\n  }, \n  \"origin\": \"131.111.5.14\", \n  \"url\": \"http://httpbin.org/post\"\n}\n"
```
...
#> $headers
#> $headers$date
#> [1] "Mon, 27 Mar 2023 19:02:35 GMT"
#> 
#> 
#> $raw
...
#> [176] 65 38 34 62 2d 35 61 34 66 34 65 37 34 31 30 39 65 37 65 37 63 31 37 30 30
#> [201] 36 64 38 61 22 0a 20 20 7d 2c 20 0a 20 20 22 6f 72 69 67 69 6e 22 3a 20 22
...
#> 
#> $data
#> [1] "{\n  \"args\": {}, \n  \"headers\": {\n    \"Authorization\": \"Bearer APIKEY\", \n    \"Content-Type\": \"application/json\", \n    \"Host\": \"httpbin.org\", \n    \"X-Amzn-Trace-Id\": \"Root=1-6421e84b-5a4f4e74109e7e7c17006d8a\"\n  }, \n  \"origin\": \"131.111.5.14\", \n  \"url\": \"https://httpbin.org/get\"\n}\n"
```
