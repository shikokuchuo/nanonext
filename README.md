...
#>  - $data for message data
aio$data |> str()
#>  num [1:100000000] -1.618 -0.461 0.932 -1.701 -0.696 ...
```
...
#> 
#> $data
#> [1] "{\n  \"args\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-64f4d3c2-2aad84fa2767993e463fba16\"\n  },\n  \"url\": \"https://postman-echo.com/get\"\n}"
```
...
#> $date
#> [1] "Sun, 03 Sep 2023 18:43:15 GMT"

res$data
#> [1] "{\n  \"args\": {},\n  \"data\": {\n    \"key\": \"value\"\n  },\n  \"files\": {},\n  \"form\": {},\n  \"headers\": {\n    \"x-forwarded-proto\": \"https\",\n    \"x-forwarded-port\": \"443\",\n    \"host\": \"postman-echo.com\",\n    \"x-amzn-trace-id\": \"Root=1-64f4d3c3-6b76d6564407175613076cdb\",\n    \"content-length\": \"16\",\n    \"content-type\": \"application/json\",\n    \"authorization\": \"Bearer APIKEY\"\n  },\n  \"json\": {\n    \"key\": \"value\"\n  },\n  \"url\": \"https://postman-echo.com/post\"\n}"
```
...
#> [151] 20 22 52 6f 6f 74 3d 31 2d 36 34 66 34 64 33 63 33 2d 35 38 32 31 30 66 35
#> [176] 39 32 61 36 64 33 63 66 36 32 33 32 65 66 34 63 63 22 2c 0a 20 20 20 20 22
