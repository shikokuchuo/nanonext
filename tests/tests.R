...
nanotesti(aio_data(msg), aio_data_(msg))
...
nanotest(is_error_value(aio_data(err)))
nanotest(is_error_value(aio_data(list(data = err))[["data"]]))
nanotest(is_error_value(aio_data_(list(err))[[1L]]))
...
nanotesterr(aio_data("a"), "object is not an Aio or list of Aios")
nanotesterr(aio_data_(list("a")), "object is not an Aio or list of Aios")
nanotesterr(aio_data(list(fakesock)), "object is not an Aio or list of Aios")
