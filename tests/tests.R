...
nanotest(identical(next_config(nxt), nxt))
nanotest(identical(next_config(as.pairlist(c("a", "b", "c"))), nxt))
...
nanotest(typeof(ctxn <- .context(rep)) == "externalptr")
nanotestaio(cs <- request2(.context(req$socket), data = TRUE))
...
nanotest(is.null(stop_aio(put1)))
