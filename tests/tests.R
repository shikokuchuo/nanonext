...
nanotest(is_ncurl_session(b <- ncurl_session("https://www.cam.ac.uk/", tls = tls)) || is_error_value(b))
if (is_ncurl_session(b)) nanotest(is_error_value(transact(b)[["headers"]]))
