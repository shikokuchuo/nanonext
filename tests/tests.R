...
nanotest(n$recv() == 8L)
nanotestz(n$setopt("size", "recv-size-max", 8192))
nanotest(n$getopt("size", "recv-size-max") == 8192L)
nanotestz(n$setopt("int", "recv-buffer", 8))
nanotest(n$getopt("int", "recv-buffer") == 8L)
nanotestz(n$setopt("string", "socket-name", "nano"))
nanotest(n$getopt("string", "socket-name") == "nano")
...
nanotestz(n$listener_setopt("size", "recv-size-max", 1024)[[1L]])
nanotest(n$listener_getopt("size", "recv-size-max")[[1L]] == 1024L)
nanotestw(n$listener_setopt("bool", "false", FALSE) == 9L)
nanotest(n$listener_getopt("bool", "false")[[1L]] == 9L)
nanotestw(n$listener_setopt("int", "false", 100L) == 9L)
nanotest(n$listener_getopt("int", "false")[[1L]] == 9L)
nanotestw(n$listener_setopt("ms", "false", 100L) == 9L)
nanotest(n$listener_getopt("ms", "false")[[1L]] == 9L)
nanotestw(n$listener_setopt("string", "false", "false") == 9L)
nanotest(n$listener_getopt("string", "false")[[1L]] == 9L)
nanotestw(n$listener_setopt("string", "false", NULL) == 9L)
nanotestw(n$listener_setopt("uint64", "false", 100) == 9L)
nanotest(n$listener_getopt("uint64", "false")[[1L]] == 9L)
...
nanotestz(n1$dialer_setopt("ms", "reconnect-time-min", 1000)[[1L]])
nanotest(n1$dialer_getopt("ms", "reconnect-time-min")[[1L]] == 1000L)
nanotestz(n1$dialer_setopt("size", "recv-size-max", 8192)[[1L]])
nanotest(n1$dialer_getopt("size", "recv-size-max")[[1L]] == 8192L)
nanotestw(n1$dialer_setopt("bool", "false", FALSE) == 9L)
nanotest(n1$dialer_getopt("bool", "false")[[1L]] == 9L)
nanotestw(n1$dialer_setopt("int", "false", 100L) == 9L)
nanotest(n1$dialer_getopt("int", "false")[[1L]] == 9L)
nanotestw(n1$dialer_setopt("string", "false", "false") == 9L)
nanotest(n1$dialer_getopt("string", "false")[[1L]] == 9L)
nanotestw(n1$dialer_setopt("string", "false", NULL) == 9L)
nanotestw(n1$dialer_setopt("uint64", "false", 100) == 9L)
nanotest(n1$dialer_getopt("uint64", "false")[[1L]] == 9L)
...
nanotesterr(setopt(rraio[["aio"]], "int", "false", 0L), "valid")
...
rep
nanotestz(req$setopt("ms", "req:resend-time", 1000))
nanotest(req$getopt("ms", "req:resend-time") == 1000L)
nanotesterr(req$setopt("none", "req:resend-time", 1000), "type")
nanotesterr(req$getopt("none", "req:resend-time"), "type")
nanotesterr(req$setopt("s", "req:resend-time", 1000), "type")
nanotesterr(req$getopt("s", "req:resend-time"), "type")
...
nanotestz(req$setopt("ms", "send-timeout", 1000))
nanotest(req$getopt("ms", "send-timeout") == 1000L)
nanotestw(req$setopt("int", "false", 100L) == 9L)
nanotest(req$getopt("int", "false") == 9L)
nanotestw(req$setopt("bool", "false", FALSE) == 9L)
nanotest(req$getopt("bool", "false") == 9L)
nanotestw(req$setopt("size", "false", 100L) == 9L)
nanotest(req$getopt("size", "false") == 9L)
nanotestw(req$setopt("string", "false", "false") == 9L)
nanotestw(req$setopt("string", "false", NULL) == 9L)
nanotest(req$getopt("string", "false") == 9L)
nanotestw(req$setopt("uint64", "false", 100) == 9L)
nanotest(req$getopt("uint64", "false") == 9L)
ctx <- context(rep)
ctx
...
nanotestz(sub$setopt(type = "bool", opt = "sub:prefnew", value = FALSE))
nanotest(!sub$getopt(type = "bool", opt = "sub:prefnew"))
nanotestw(sub$setopt(type = "uint64", opt = "false", value = 100) == 9L)
nanotest(sub$getopt(type = "uint64", opt = "false") == 9L)
...
nanotesterr(setopt(fakestream, type = "int", opt = "test", value = "test"), "valid")
nanotesterr(getopt(fakestream, type = "int", opt = "test"), "valid")
