...
nanotesterr(getstat(rraio[["aio"]], "pipes"), "valid")
...
rep
nanotest(getstat(rep, "pipes") == 1)
nanotest(getstat(rep, "protocol") == "rep")
nanotestn(getstat(rep, "nonexistentstat"))
...
nanotesterr(sub$getopt(opt = "false"), "supported")
...
nanotesterr(getstat(fakesock, "pipes"), "valid Socket")
