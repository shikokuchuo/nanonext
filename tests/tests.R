...
nanotest(length(sha256("test")) == 32L)
nanotest(is.raw(sha256(c(1.1, 2.2), as.raw(1L))))
nanotest(inherits(sha256(data.frame(), "KEY"), "nanoHash"))
nanotest(length(as.character(sha256(as.raw(0L), key = NULL))) == 1L)
