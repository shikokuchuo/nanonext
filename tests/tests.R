...
suppressMessages(n$send_aio(c(1.1, 2.2), mode = "raw", timeout = 500, echo = FALSE))
invisible(suppressMessages(n1$recv_aio(mode = "double", timeout = 500)))
...
suppressMessages(ctx_send(ctx, "context test", mode ="raw", timeout = 500))
invisible(suppressMessages(ctx_recv(ctx, mode = "character", timeout = 100)))
