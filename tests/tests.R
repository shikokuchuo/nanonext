...
nanotestp(tls)
nanotest(is_error_value(ncurl("https://www.cam.ac.uk/", secure = tls)$status))
nanotest(is_error_value(call_aio(ncurl("https://www.cam.ac.uk/", async = TRUE, secure = tls))$status))
