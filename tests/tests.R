...
nanotest(is.pairlist(serial_config(req$socket, "custom", function(x) list(x = as.raw(1L)), function(x) list(x = new.env()), TRUE)))
nanotest(is.pairlist(serial_config(rep, "custom", function(x) list(x = as.raw(1L)), function(x) list(x = new.env()), TRUE)))
