...
nanotest(n$recv() == 8L)
nanotestnano(n$setopt("recv-size-max", 8192))
nanotest(n$getopt("recv-size-max") == 8192L)
nanotestnano(n$setopt("recv-buffer", 8L))
nanotestnano(n$setopt("socket-name", "nano"))
nanotest(n$getopt("socket-name") == "nano")
nanotesterr(n$setopt("socket-name", NULL), "argument")
n$listener[[1]]
...
nanotestnano(n$listener_setopt("recv-size-max", 1024)[[1L]])
nanotest(n$listener_getopt("recv-size-max")[[1L]] == 1024L)
nanotesterr(n$listener_setopt("false", 100), "supported")
nanotesterr(n$listener_getopt("false"), "supported")
nanotesterr(n$listener_setopt("false", "false"), "supported")
nanotesterr(n$listener_setopt("false", NULL), "supported")
nanotesterr(n$listener_setopt("false", TRUE), "supported")
...
nanotestnano(n1$dialer_setopt("reconnect-time-min", 1000)[[1L]])
nanotest(n1$dialer_getopt("reconnect-time-min")[[1L]] == 1000L)
nanotestnano(n1$dialer_setopt("recv-size-max", 8192)[[1L]])
nanotest(n1$dialer_getopt("recv-size-max")[[1L]] == 8192L)
nanotesterr(n1$dialer_setopt("false", 100), "supported")
nanotesterr(n1$dialer_getopt("false"), "supported")
nanotesterr(n1$dialer_setopt("false", "false"), "supported")
nanotesterr(n1$dialer_setopt("false", NULL), "supported")
nanotesterr(n1$dialer_setopt("false", TRUE), "supported")
...
nanotesterr(req$getopt("none"), "supported")
...
nanotestnano(req$setopt("send-timeout", 1000))
nanotest(req$getopt("send-timeout") == 1000L)
nanotesterr(req$setopt("false", 100), "supported")
nanotesterr(req$getopt("false"), "supported")
nanotesterr(req$setopt("false", "false"), "supported")
nanotesterr(req$setopt("false", NULL), "supported")
nanotesterr(req$setopt("false", TRUE), "supported")
...
nanotestnano(sub$setopt(name = "sub:prefnew", value = FALSE))
nanotest(!sub$getopt(name = "sub:prefnew"))
nanotesterr(sub$setopt(name = "false", value = 100), "supported")
nanotesterr(sub$getopt(name = "false"), "supported")
nanotesterr(sub$setopt(name = "false", value = list()), "type")
...
nanotestnano(surv$survey_time(time = 5000))
nanotestnn(surv$context_open())
nanotestnn(resp$context_open())
nanotestnano(surv$survey_time(time = 2000))
