...
relo <- ncurl("https://trin.cam.ac.uk/", convert = FALSE, response = "server", async = TRUE)
nanotest(is.integer(call_aio(relo)$status))
relo <- ncurl("https://trin.cam.ac.uk/", convert = FALSE, response = list("server"), async = TRUE)
nanotest(is.integer(call_aio(relo)$status))
