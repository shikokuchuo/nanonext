...
nanotesterr(aio_data_("a"), "object is not an Aio")
nanotesterr(aio_collect_(list("a")), "object is not a list of Aios")
nanotesterr(aio_collect(list(fakesock)), "object is not a list of Aios")
