...
nanotest(n$recv() > 0L)
nanotestn(n$setopt("size", "recv-size-max", 8192))
nanotestn(n$setopt("int", "recv-buffer", 8))
nanotestn(n$setopt("string", "socket-name", "nano"))
...
nanotestn(n$listener_setopt("size", "recv-size-max", 1024)[[1L]])
nanotesterr(n$listener_setopt("bool", "false", FALSE), 9)
nanotesterr(n$listener_setopt("int", "false", 100L), 9)
nanotesterr(n$listener_setopt("ms", "false", 100L), 9)
nanotesterr(n$listener_setopt("string", "false", "false"), 9)
nanotesterr(n$listener_setopt("string", "false", NULL), 9)
nanotesterr(n$listener_setopt("uint64", "false", 100), 9)
nanotestn(n$listener_start())
...
nanotestn(n1$dialer_setopt("ms", "reconnect-time-min", 1000)[[1L]])
nanotestn(n1$dialer_setopt("size", "recv-size-max", 8192)[[1L]])
nanotesterr(n1$dialer_setopt("bool", "false", FALSE), 9)
nanotesterr(n1$dialer_setopt("int", "false", 100L), 9)
nanotesterr(n1$dialer_setopt("string", "false", "false"), 9)
nanotesterr(n1$dialer_setopt("string", "false", NULL), 9)
nanotesterr(n1$dialer_setopt("uint64", "false", 100), 9)
nanotestn(n1$dialer_start())
...
nanotestn(n$dial(url = "inproc://two", autostart = TRUE))
nanotest(inherits(n$dialer[[1L]], "nanoDialer"))
nanotestn(n$listen(url = "inproc://three"))
nanotest(inherits(n$listener[[2L]], "nanoListener"))

nanotestn(close(n$listener[[1]]))
nanotesterr(close(n$listener[[1]]), 12)
nanotestn(close(n1$dialer[[1]]))
nanotesterr(close(n1$dialer[[1]]), 12)
nanotestn(n$close())
nanotestn(n1$close())
nanotesterr(n1$close(), 7)
...
rep
nanotestn(req$setopt("ms", "req:resend-time", 1000))
...
nanotestn(req$setopt("ms", "send-timeout", 1000))
nanotesterr(req$setopt("int", "false", 100L), 9)
nanotesterr(req$setopt("bool", "false", FALSE), 9)
nanotesterr(req$setopt("size", "false", 100L), 9)
nanotesterr(req$setopt("string", "false", "false"), 9)
nanotesterr(req$setopt("string", "false", NULL), 9)
nanotesterr(req$setopt("uint64", "false", 100), 9)
ctx <- context(rep)
ctx
...
nanotestn(sub$setopt(type = "bool", opt = "sub:prefnew", value = FALSE))
nanotesterr(sub$setopt(type = "uint64", opt = "false", value = 100), 9)
nanotestn(sub$subscribe("test"))
nanotestn(subscribe(sub$socket, NULL))
nanotestn(unsubscribe(sub$socket, NULL))
nanotestn(sub$unsubscribe("test"))
nanotestnn(sub$context_open())
nanotest(inherits(sub$context, "nanoContext"))
nanotestn(sub$subscribe(12))
nanotestn(sub$unsubscribe(12))
nanotestn(sub$context_close())
...
nanotestn(surv$survey_time(time = 5000))
nanotestnn(surv$context_open())
nanotestnn(resp$context_open())
nanotestn(surv$survey_time(time = 2000))
nanotestn(surv$context_close())
nanotestn(resp$context_close())
nanotestn(surv$close())
nanotestn(resp$close())
...
nanotestn(close(bus))
nanotestn(close(push))
nanotestn(close(pull))
nanotestn(survey$close())
nanotestn(respond$close())
