...
invisible(suppressWarnings(n$send("not ready")) > 0L || stop())
invisible(suppressWarnings(n$recv()) > 0L || stop())
...
invisible(is.null(stop_aio(n)) || stop())
invisible(identical(call_aio(msg), msg) || stop())
invisible(identical(call_aio(n), n) || stop())
...
invisible(suppressWarnings(close(n$listener[[1]])) > 0L || stop())
invisible(close(n1$dialer[[1]]) == 0L || stop())
invisible(suppressWarnings(close(n1$dialer[[1]])) > 0L || stop())
invisible(n$close() == 0L || stop())
invisible(n1$close() == 0L || stop())
invisible(suppressWarnings(n1$close()) > 0L || stop())
...
invisible(suppressWarnings(close(ctx)) > 0L || stop())
...
invisible(is.integer(suppressWarnings(ncurl("http://127.0.0.1:5555"))) || stop())
invisible(is.integer(suppressWarnings(stream(dial = "tcp://127.0.0.1:5555"))) || stop())
